...
public class MediaFormatWnd extends JDialog implements ActionListener {
	...
	private void initUI() {
		...
		final JComboBox<FormatGroup> cmbFormatGroup = new JComboBox<>(model);
		...
		final DefaultListModel<Format> listModel = new DefaultListModel<>();
		...
		final DefaultComboBoxModel<String> modelAsr = new DefaultComboBoxModel<>();
		cmbAsr = new JComboBox<>(modelAsr);
		cmbAsr.setBounds(x, y, getScaledInt(100), getScaledInt(25));
		add(cmbAsr);
		x += getScaledInt(115);

		final DefaultComboBoxModel<String> modelAbr = new DefaultComboBoxModel<>();
		cmbAbr = new JComboBox<>(modelAbr);
		cmbAbr.setBounds(x, y, getScaledInt(100), getScaledInt(25));
		add(cmbAbr);
		x += getScaledInt(115);

		final DefaultComboBoxModel<String> modelAc = new DefaultComboBoxModel<>();
		cmbAc = new JComboBox<>(modelAc);
		cmbAc.setBounds(x, y, getScaledInt(100), getScaledInt(25));
		add(cmbAc);
		x += getScaledInt(115);

		final DefaultComboBoxModel<String> modelSize = new DefaultComboBoxModel<>();
